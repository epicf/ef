...
plt.plot(R_beam+beam_center_x,phi_beam, color = 'g', label = "theory_beam")
plt.plot(-1*R_beam+beam_center_x,phi_beam, color = 'g')
plt.plot(R_empty+beam_center_x,phi_empty, color = 'r', label = "theory_empty_space")
plt.plot(-1*R_empty+beam_center_x,phi_empty, color = 'r')
