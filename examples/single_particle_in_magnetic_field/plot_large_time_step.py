...
def find_necessary_out_files():
    os.chdir("./")
    h5files = []
    for file in glob.glob("large_time_step_[0-9]*.h5"):
        h5files.append( file )
    return h5files
...
def plot_3d( num, an ):
    ...
    #plt.show()
    print( 'Saving 3d trajectory plot to "large_time_step_3d.png"' )
...
def plot_2d( num, an ):
    ...
    print( 'Saving 2d trajectory projection plots to "large_time_step_2d.png"' )
...
def plot_kin_en( num , an ):
    ...
    print( 'Saving kinetic energy comparison plot to "large_time_step_kin_en.png"' )
    plt.savefig( 'large_time_step_kin_en.png' )
