...
z=np.array([])
n=1
h5y=h5["/ParticleSources/cathode_emitter/position_y"][1::n]
h5x=h5["/ParticleSources/cathode_emitter/position_x"][1::n]
h5z=h5["/ParticleSources/cathode_emitter/position_z"][1::n]
