...
def get_source_geometry( h5file ):
    start_y = h5file["/ParticleSources/cathode_emitter"].attrs["box_y_top"][0]
    end_y = h5file["/ParticleSources/cathode_emitter"].attrs["box_y_bottom"][0]
...
def get_zlim( h5file ):
    start_z = h5file["/ParticleSources/cathode_emitter"].attrs["box_z_near"][0]
    end_z = h5file["/SpatialMesh/"].attrs["z_volume_size"][0]
